...
print(f'Total amount paid for stock: $  {amount: .1f}' )
print(f'Commission paid on the purchase: $ {pre_com: .1f}' )
print(f'Amount the stock sold for: $ {sold: .1f}')
print(f'Commission paid on the sale: $ {post_com: .1f}')
print(f'Total commission paid: $ {total_com: .1f}')
